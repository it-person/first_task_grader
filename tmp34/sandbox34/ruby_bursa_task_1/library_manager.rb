class LibraryManager
  ...
  def penalty price, issue_datetime
    ...
    diff_in_hours = (this_moment.to_time - issue_datetime.to_time).to_i / 3600
    return 0 if price < 0 || diff_in_hours < 0
    (price*0.001*diff_in_hours).round
  end
  ...
  def author_translit ukr_name
    mapping = [['А','а'], ['a','а'], ['Б','b'], ['б','b'], [' Й','y'], [' й','y'], ['Й','i'], ['й','i']]
    name = ukr_name.split.map{|substr| " "+substr}.join(' ')
    mapping.map{|el| name.gsub!(el[0], el[1])}
    name
  end
