class LibraryManager
  ...
  def penalty price, issue_datetime
    ...
    hours = ((now - issue_datetime)*24)
    hours = 0 if hours <= 0
    res = (price * hours * 0.001).to_f.round 
  ...
  def could_meet_each_other? year_of_birth_first, year_of_death_first, year_of_birth_second, year_of_death_second
    # решение пишем тут
    a = year_of_birth_first.between?(year_of_birth_second,year_of_death_second)
    b = year_of_death_first.between?(year_of_birth_second,year_of_death_second)
    c = year_of_birth_second.between?(year_of_birth_first,year_of_death_first)
    d = year_of_death_second.between?(year_of_birth_first,year_of_death_first)
    res = a || b || c || d
