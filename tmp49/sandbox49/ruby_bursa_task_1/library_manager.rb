...
class LibraryManager
  ...
  def penalty price, issue_datetime
    ...
    return penya = (DateTime.now - issue_datetime).to_i * (price*0.001)
...
#  penalty 0, 0
  ...
  def could_meet_each_other? year_of_birth_first, year_of_death_first, year_of_birth_second, year_of_death_second
    # решение пишем тут
    #t1 = year_of_birth_first..year_of_death_first
    #t2 = year_of_birth_second..year_of_death_second
    #return if t1.in?(t2)
    (year_of_birth_first..year_of_death_first).overlaps?(year_of_birth_first..year_of_death_first)
  ...
  def penalty_to_finish price, issue_datetime, pages_quantity, current_page, reading_speed
    # решение пишем тут
    d = ((pages_quantity - current_page) / reading_speed ) * (price * 0.001) * (issue_datetime - DateTime.now)
    return d <= price ? 0 : d
